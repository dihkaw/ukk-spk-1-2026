...
```bash
wget https://raw.githubusercontent.com/dihkaw/ukk-spk-1-2026/main/sh/setup-server.sh -O setup-server.sh && sudo chmod +x setup-server.sh && sudo ./setup-server.sh
```
